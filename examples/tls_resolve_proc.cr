...
servers << Durian::Resolver::Server.new(
  ipAddress: Socket::IPAddress.new("8.8.8.8", 853_i32),
  protocol: Durian::Protocol::TLS,
  tls: Durian::Resolver::Server::TransportLayerSecurity.new(hostname: "dns.google.com")
)
